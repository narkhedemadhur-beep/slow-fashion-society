      ...
      <section className="py-24 md:py-32 bg-secondary">
        <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Curating sustainable fashion, one unique piece at a time
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Slow Fashion Society was born from a simple belief: fashion should be both beautiful and responsible. In a world of fast fashion, we choose to slow down, to curate, and to celebrate the stories behind each piece.
              </p>
              <p className="text-lg leading-relaxed mb-6">
                Every item in our collection is pre-loved, vintage, or sustainably sourced. We believe that the most sustainable garment is the one that already exists.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              ...
              <p className="text-muted-foreground">
                Each piece is carefully inspected and selected for its craftsmanship and condition.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 shadow-sm">
